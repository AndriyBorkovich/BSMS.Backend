        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousStopId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stops_Stops_PreviousStopId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusReviewId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BusId = table.Column<int>(type: "int", nullable: false),
                    PassengerId = table.Column<int>(type: "int", nullable: false),
                    ComfortRating = table.Column<int>(type: "int", nullable: true),
                    PunctualityRating = table.Column<int>(type: "int", nullable: true),
                    PriceQualityRatioRating = table.Column<int>(type: "int", nullable: true),
                    InternetConnectionRating = table.Column<int>(type: "int", nullable: true),
                    SanitaryConditionsRating = table.Column<int>(type: "int", nullable: true),
                    Comments = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReviewDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusReviews", x => x.BusReviewId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BusReviews_Passengers_PassengerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_Stops_EndStopId",
                        column: x => x.EndStopId,
                        principalTable: "Stops",
                        principalColumn: "StopId");
                    table.ForeignKey(
                        name: "FK_Tickets_Stops_StartStopId",
